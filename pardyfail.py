...
def procesar_cola():
    ...
    while cola_tareas:
        ...
        procesar_imagen(path_imagen, numero_usuario)
    estado_sistema = "libre"

def procesar_imagen(path_imagen, numero_usuario):
    try:
    ...
    prompt = f"{description} cartoon,animated,Traditional hand-drawn animation of my melody character,The character has a large pink bunny ear on the top of his head, he is wearing a pink scarf around his neck and is holding a bouquet of yellow flowers, suggesting a friendly and adorable design, the background is the blue sky"
    ...
    #gen_path = rf"C:\Users\jairc\Pictures\ComfyUI\output\{name}_00002_.png"
